...
public class ComparableExample {
	public static void main(String[] args) {
        ...
        Student student1 = new Student("Amisha patel", 23, 90.22);
        Student student2 = new Student("Ravi sharma", 21, 92.43);
        Student student3 = new Student("Shakti patel", 25, 84.7);
        Student student4 = new Student("Pankaj Gupta", 20, 87.50);
